...
export const metadata: Metadata = {
  ...
  generator: "v0.app",
  keywords: ["Web3", "Hiking", "Move-to-Earn", "Flare Network", "HIKE tokens", "dApp"],
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`font-sans ${inter.variable} ${jetbrainsMono.variable} ${dmSans.variable} antialiased`}>
        <WalletProvider>
          <DashboardHeader />
